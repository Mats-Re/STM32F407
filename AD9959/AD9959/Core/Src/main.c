...
int main(void)
{
  ...
  /* USER CODE BEGIN 2 */
	...
	AD9959_Set_Fre(CH1, 1000);	//设置通道1频率100000Hz
	AD9959_Set_Fre(CH2, 1000);	//设置通道2频率100000Hz
	AD9959_Set_Fre(CH3, 1000);	//设置通道3频率100000Hz
		
	AD9959_Set_Amp(CH0, 1023); 		//设置通道0幅度控制值1023，范围0~1023
	AD9959_Set_Amp(CH1, 512/267*200); 		//设置通道1幅度控制值1023，范围0~1023
